...
data class Cabello(var tituloImg: Int, var titulo : String) : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<Cabello> {
        override fun createFromParcel(parcel: Parcel): Cabello {
            return Cabello(parcel)
        }

        override fun newArray(size: Int): Array<Cabello?> {
