...
class UnasAdapter(private val UnasList: ArrayList<Unas>) : RecyclerView.Adapter<UnasAdapter.MyViewHolder>() {

    var onItemClick : ((Unas) -> Unit)? = null
